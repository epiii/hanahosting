...
<script src="client/s_mkatdonatur.js"></script>
...
<ol class="breadcrumb">
  <li class="active">Kategori Donatur / </li>
  <li ><a href="detail-donatur">Detail Kategori Donatur</a></li>
</ol>
...
<div class="span8"id="i_kegPN" style="display:none;"><br>
	<div class="span8">
		...
		<input type="hidden" id="idformTB" name="idformTB"/>
			...
			<div class="controls" >
            	<input type="text" placeholder="Isikan Kategori Donatur" name="mdonaturTB" id="mdonaturTB" required />
			</div>
		</div>
