...
<script src="client/s_mkantor.js"></script>
...
<div class="span8"id="i_kegPN" style="display:none;"><br>
	<div class="span8">
		...
		<input type="hidden" id="idformTB" name="idformTB"/>
			...
			<div class="controls" >
            	<input type="text" placeholder="Isikan User" name="kantorTB" id="kantorTB" required />
			</div>
			<label class="control-label">Alamat</label>
			<div class="controls" >
            	<input type="text" placeholder="isikan pass" name="alamatTB" id="alamatTB" required />
			</div>			
		</div>
