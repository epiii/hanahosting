...
<script src="client/s_mkatpenerima.js"></script>
<!-- <h4><div id="loadarea"><i class="icon-th-list"></i>DAFTAR JABATAN</div></h4> -->
<h3><div id="loadarea"><i class="icon-th-list"></i>DAFTAR PENERIMA DONASI</div></h3>
<ol class="breadcrumb">
  <li class="active">Kategori Penerima Donasi / </li>
  <li ><a href="detail-penerima">Detail Penerima Donasi</a></li>
</ol>
...
<div class="span8"id="i_kegPN" style="display:none;"><br>
	<div class="span8">
		...
		<input type="hidden" id="idformTB" name="idformTB"/>
			...
			<div class="controls" >
            	<input type="text" placeholder="Isikan Kategori Penerima" name="katTB" id="katTB" required />
			</div>			
		</div>
