...
<ol class="breadcrumb">
  <li><a href="kategori-pembayaran">Kategori Tipe Pembayaran</a> /</li>
...
<div Xclass="span8"id="i_kegPN" style="display:none;"><br>
	<div class="span8">
		...
		<div class="control-group">
			...
			<div class="controls" >
				<input  name="no_rekTB" id="no_rekTB"  placeholder="nomer rekening ">
			</div>
			<span id="mkotaInfo"></span>
		</div>
...
<div Xclass="span8"id="v_kegPN"><br>
	<table class="table table-hover table-bordered table-striped" width="100%" border="0">
		<tr>
			...
			<td><input class="span1" placeholder="no rekening" name="no_rekTS" id="no_rekTS"></td>
			<td></td>
		</tr>
