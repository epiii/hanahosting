...
<script src="client/s_mlogin.js"></script>
...
<div class="span8"id="i_kegPN" style="display:none;"><br>
	<div class="span8">
		...
		<input type="hidden" id="idformTB" name="idformTB"/>
			...
			<div class="controls" >
            	<input type="text" placeholder="Isikan User" name="userTB" id="userTB" required />
			</div>
			<label class="control-label">Password</label>
			<div class="controls" >
            	<input type="text" placeholder="isikan pass" name="passTB" id="passTB" required />
			</div>
			<label class="control-label">Email</label>
			<div class="controls" >
            	<input type="text" placeholder="isikan Email" name="emailTB" id="emailTB" required />
			</div>
