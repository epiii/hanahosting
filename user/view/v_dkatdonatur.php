...
<script src="client/s_dkatdonatur.js"></script>
<h3><div id="loadarea"><i class="icon-th-list"></i>DAFTAR KATEGORI DONATUR </div></h3>
<ol class="breadcrumb">
  <li><a href="kategori-penerima">Kategori Donatur / </a></li>
  <li class="active">Detail Kategori Donatur</li>
</ol>
...
<div Xclass="span8"id="i_kegPN" style="display:none;"><br>
	<div class="span8">
		...
		<div class="control-group">
			<label class="control-label">Kategori Donatur</label>
			<div class="controls" >
				<select name="id_mkatdonaturTB" id="id_mkatdonaturTB" required>
		...
		<div class="control-group">
			<label class="control-label">Detail Tipe Pembayaran</label>
			<div class="controls" >
				<select name="id_dtipebayarTB" id="id_dtipebayarTB"  required>
					<option value="">Detail Tipe Pembayaran ...</option>
				</select> 
			</div>
			<span id="mkotaInfo"></span>
		</div>
...
<div Xclass="span8"id="v_kegPN"><br>
	<table class="table table-hover table-bordered table-striped" width="100%" border="0">
		<tr>
			<td></td>
			<td><input class="span1" placeholder="kategori donatur" name="mkatdonaturTS" id="mkatdonaturTS"></td>
			<td><input class="span1" placeholder="detail penerima" name="dtipebayarTS" id="dtipebayarTS"></td>
			<td></td>
		</tr>

		<tr class="info">
			<td><b>No.</b></td>
			<td><b>Kategori Donatur</b></td>
			<td><b>Detail Tipe Pembayaran</b></td>
