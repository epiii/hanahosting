...
<!-- <br> -->
	<table class="table table-hover table-bordered table-striped" Xwidth="100%" border="0">
		<tr>
			...
			<td><input class="span1" placeholder="kategori" name="mkatdonaturTS" id="mkatdonaturTS"></td>
			<td><input class="span1" placeholder="via" name="mtipebayarTS" id="mtipebayarTS"></td>
			<td></td>
		</tr>
		<tr class="info">
			<td><b>No.</b></td>
